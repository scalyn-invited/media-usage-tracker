        ...
        return array(
            ...
            array(
                ...
                'items' => array(
                    ...
                    array(
                        'q' => 'Does MUT scan ACF fields on taxonomy terms?',
                        'a' => '<p>Yes. MUT scans ACF image, file, and gallery fields on all public taxonomy terms — including categories, tags, product categories, and any custom taxonomies. Fields inside repeaters, flexible content layouts, and groups on taxonomy terms are also detected recursively.</p><p>The context label shows the taxonomy and term name — for example: <code>ACF (product_cat: Electronics): Banner Image</code>.</p>',
                    ),
                    array(
